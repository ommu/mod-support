...
class ViewsController extends Controller
{
	...
	public function actionIndex() 
	{
		...
		$setting = SupportFeedbackView::model()->findByPk(1,array(
		...
		$dataProvider = new CActiveDataProvider('SupportFeedbackView', array(
			'criteria'=>$criteria,
			'pagination'=>array(
				'pageSize'=>10,
			),
		...
		$this->pageTitle = Yii::t('phrase', 'Support Feedback Views');
	...
	public function actionManage() 
	{
		...
		if(isset($_GET['SupportFeedbackView'])) {
			$model->attributes=$_GET['SupportFeedbackView'];
		}
	...
	public function actionAdd() 
	{
		...
		if(isset($_POST['SupportFeedbackView'])) {
			$model->attributes=$_POST['SupportFeedbackView'];
				...
				if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
					if($model->save()) {
						echo CJSON::encode(array(
							...
							'msg' => '<div class="errorSummary success"><strong>'.Yii::t('phrase', 'SupportFeedbackView success created.').'</strong></div>',
						));
					} else {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', Yii::t('phrase', 'SupportFeedbackView success created.'));
		...
		$this->pageTitle = Yii::t('phrase', 'Create Support Feedback Views');
		$this->pageDescription = '';
		$this->pageMeta = '';
	...
	public function actionEdit($id) 
	{
		...
		if(isset($_POST['SupportFeedbackView'])) {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', Yii::t('phrase', 'SupportFeedbackView success updated.'));
					//$this->redirect(array('view','id'=>$model->view_id));
					$this->redirect(array('manage'));
				}
			}
		...
		$this->pageTitle = Yii::t('phrase', 'Update Support Feedback Views');
		$this->pageDescription = '';
		$this->pageMeta = '';
