...
<div id="partial-support-feedback-view-history">
	<?php //begin.Messages ?>
	<div id="ajax-message">
	<?php
	...
	<div class="boxed">
		...
		<?php 
			...
			array_push($columnData, array(
				...
				'buttons' => array(
					'view' => array(
						'label' => Yii::t('phrase', 'Detail Feedback View History'),
						'imageUrl' => false,
						'options' => array(
							'class' => 'view',
						),
					...
					'update' => array(
						'label' => Yii::t('phrase', 'Update Feedback View History'),
						'imageUrl' => false,
						'options' => array(
							'class' => 'update',
						),
					...
					'delete' => array(
						'label' => Yii::t('phrase', 'Delete Feedback View History'),
						'imageUrl' => false,
						'options' => array(
							'class' => 'delete',
						),
