...
$this->params['menu']['content'] = [
	...
	['label' => Yii::t('app', 'View'), 'url' => Url::to(['view', 'id' => $model->widget_id]), 'icon' => 'eye'],
	['label' => Yii::t('app', 'Delete'), 'url' => Url::to(['delete', 'id' => $model->widget_id]), 'confirm' => Yii::t('app', 'Are you sure you want to delete this item?'), 'method' => 'post', 'icon' => 'trash'],
];
?>
