...
class ReplyController extends Controller
{
	...
	public function actionIndex() 
	{
		...
		$setting = SupportFeedbackReply::model()->findByPk(1,array(
		...
		$dataProvider = new CActiveDataProvider('SupportFeedbackReply', array(
			'criteria'=>$criteria,
			'pagination'=>array(
				'pageSize'=>10,
			),
		...
		$this->pageTitle = Yii::t('phrase', 'Support Feedback Replies');
	...
	public function actionAdd() 
	{
		...
		if(isset($_POST['SupportFeedbackReply'])) {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', Yii::t('phrase', 'SupportFeedbackReply success created.'));
	...
	public function actionEdit($id) 
	{
		...
		if(isset($_POST['SupportFeedbackReply'])) {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', Yii::t('phrase', 'SupportFeedbackReply success updated.'));
					//$this->redirect(array('view','id'=>$model->reply_id));
					$this->redirect(array('manage'));
				}
			}
