...
$this->params['menu']['content'] = [
	['label' => Yii::t('app', 'Add Support Widget'), 'url' => Url::to(['create']), 'icon' => 'plus-square'],
];
			...
			array_push($columnData, [
				...
				'buttons' => [
					'view' => function ($url, $model, $key) {
						...
						return Html::a('<span class="glyphicon glyphicon-eye-open"></span>', $url, ['title' => Yii::t('app', 'View Support Widget')]);
					},
					'update' => function ($url, $model, $key) {
						$url = Url::to(['update', 'id'=>$model->primaryKey]);
						return Html::a('<span class="glyphicon glyphicon-pencil"></span>', $url, ['title' => Yii::t('app', 'Update Support Widget')]);
					},
					'delete' => function ($url, $model, $key) {
						$url = Url::to(['delete', 'id'=>$model->primaryKey]);
						return Html::a('<span class="glyphicon glyphicon-trash"></span>', $url, [
							'title' => Yii::t('app', 'Delete Support Widget'),
