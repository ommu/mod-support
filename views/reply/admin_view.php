...
$this->params['menu']['content'] = [
	...
	['label' => Yii::t('app', 'Update'), 'url' => Url::to(['update', 'id' => $model->reply_id]), 'icon' => 'eye'],
	['label' => Yii::t('app', 'Delete'), 'url' => Url::to(['delete', 'id' => $model->reply_id]), 'confirm' => Yii::t('app', 'Are you sure you want to delete this item?'), 'method' => 'post', 'icon' => 'trash'],
];
?>
