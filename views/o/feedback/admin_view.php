...
<div class="dialog-content">
	<?php $this->widget('zii.widgets.CDetailView', array(
		...
		'attributes'=>array(
			...
			array(
				'name'=>'replied_date',
				'value'=>!in_array($model->replied_date, array('0000-00-00 00:00:00','1970-01-01 00:00:00','0002-12-02 07:07:12','-0001-11-30 00:00:00')) ? $this->dateFormat($model->replied_date, true) : '-',
			),
			array(
				'name'=>'replied_id',
