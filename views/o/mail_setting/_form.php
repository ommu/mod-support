	...
	<fieldset>
		...
		<div class="form-group row">
			...
			<div class="col-lg-8 col-md-9 col-sm-12">
				...
				<span class="small-px"><?php echo Yii::t('phrase', 'Enter the email address you want contact form messages to be sent to.');?></span>
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-lg-8 col-md-9 col-sm-12">
				...
				<span class="small-px"><?php echo Yii::t('phrase', 'Enter the name you want the emails from the system to come from in the field below.');?></span>
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-lg-8 col-md-9 col-sm-12">
				...
				<span class="small-px"><?php echo Yii::t('phrase', 'Enter the email address you want the emails from the system to come from in the field below.');?></span>
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-lg-8 col-md-9 col-sm-12">
				<?php echo $form->textField($model,'mail_count',array('maxlength'=>32,'class'=>'form-control')); ?>
				<?php echo $form->error($model,'mail_count'); ?>
				<span class="small-px"><?php echo Yii::t('phrase', 'The number of emails to send out each time the Background Mailer task is run.');?></span>
			</div>
		</div>
		...
		<div id="smtp" <?php echo $model->mail_smtp == '0' ? 'class="hide"' : ''; ?>>
			...
			<div class="form-group row">
				...
				<div class="col-lg-8 col-md-9 col-sm-12">
					...
					<span class="small-px"><?php echo Yii::t('phrase', 'Default: 25. Also commonly on port 465 (SMTP over SSL) or port 587.');?></span>
				</div>
			</div>
