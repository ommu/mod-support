	...
	protected function afterConstruct() {
		if(count($this->templateColumns) == 0) {
			...
			$this->templateColumns['replied_date'] = array(
				'name' => 'replied_date',
				'value' => '!in_array($data->replied_date, array(\'0000-00-00 00:00:00\', \'1970-01-01 00:00:00\', \'0002-12-02 07:07:12\', \'-0001-11-30 00:00:00\')) ? Utility::dateFormat($data->replied_date) : \'-\'',
				'htmlOptions' => array(
					'class' => 'center',
				),
