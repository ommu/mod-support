...
<div class="col-md-12 col-sm-12 col-xs-12">
	<?php echo Html::a(Yii::t('app', 'Create Support Feedbacks'), ['create'], ['class' => 'btn btn-success']) ?>
			...
			array_push($columnData, [
				...
				'buttons' => [
					'view' => function ($url, $model, $key) {
						...
						return Html::a('<span class="glyphicon glyphicon-eye-open"></span>', $url, ['title' => Yii::t('app', 'View Support Feedbacks')]);
					},
