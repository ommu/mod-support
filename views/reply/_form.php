...
<!-- <?php echo $form->field($model, 'feedback_id', ['template' => '{label}<div class="col-md-6 col-sm-6 col-xs-12">{input}{error}</div>'])
...
<?php 
	...
	echo $form
	->field($model, 'feedback_id', ['template' => '{label}<div class="col-md-6 col-sm-6 col-xs-12">{input}{error}</div>'])
	->dropDownList($data, ['prompt' => 'Pilih Feedback'])
	->label($model->getAttributeLabel('feedback_id'), ['class'=>'control-label col-md-3 col-sm-3 col-xs-12']); 
?>

<?php echo $form->field($model, 'reply_message', ['template' => '{label}<div class="col-md-6 col-sm-6 col-xs-12">{input}{error}</div>'])
