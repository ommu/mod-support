...
<div id="partial-support-feedback-user">
	<?php //begin.Messages ?>
	<div id="ajax-message">
	<?php
	...
	<div class="boxed">
		...
		<?php 
			...
			array_push($columnData, array(
				...
				'buttons' => array(
					'view' => array(
						'label' => Yii::t('phrase', 'Detail Feedback User'),
						'imageUrl' => false,
						'options' => array(
							'class' => 'view',
						),
					...
					'update' => array(
						'label' => Yii::t('phrase', 'Update Feedback User'),
						'imageUrl' => false,
						'options' => array(
							'class' => 'update',
						),
					...
					'delete' => array(
						'label' => Yii::t('phrase', 'Delete Feedback User'),
						'imageUrl' => false,
						'options' => array(
							'class' => 'delete',
						),
